package com.ivairpuerari.workshopmongo.resource;
...
import com.ivairpuerari.workshopmongo.services.UserService;
...
public class UserResource {
	...
	public ResponseEntity<List<UserDTO>> findAll(){
		...
		List<UserDTO> objs = list.stream().map(x -> new UserDTO(x)).collect(Collectors.toList());
